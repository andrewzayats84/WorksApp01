sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("zjblessons/WorksApp01/app", ".html");
		...
		return Opa5.extend("zjblessons.WorksApp01.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["zjblessons/WorksApp01/localService/mockserver"], function (mockserver) {
